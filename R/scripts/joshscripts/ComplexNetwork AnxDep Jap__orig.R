JapanData = read.csv("~/Dropbox/Hofmann Papers/Japan Data Projects/Japandata.csv",header = TRUE)
...
AD1 <- JapanData[,c("Oa1.frequency", "Oa2.severity", "Oa3.avoidance", "Oa4.work", "Oa5.relation", "Od1.frequency", "Od2.severity", "Od3.avoidance", "Od4.work", "Od5.relation" )]
AD2 <- JapanData[,c("T2.Oa1.frequency", "T2.Oa2.severity", "T2.Oa3.avoidance", "T2.Oa4.work", "T2.Oa5.relation", "T2.Od1.frequency", "T2.Od2.severity", "T2.Od3.avoidance", "T2.Od4.work", "T2.Od5.relation" )]
...
AD1 <- JapanData[,c("Oa1.frequency", "Oa2.severity", "Oa3.avoidance", "Oa4.work", "Oa5.relation", "Od1.frequency", "Od2.severity", "Od3.avoidance", "Od4.work", "Od5.relation", "T1SDISS" )]
AD2 <- JapanData[,c("T2.Oa1.frequency", "T2.Oa2.severity", "T2.Oa3.avoidance", "T2.Oa4.work", "T2.Oa5.relation", "T2.Od1.frequency", "T2.Od2.severity", "T2.Od3.avoidance", "T2.Od4.work", "T2.Od5.relation", "T2SDISS" )]
colnames(AD1) <- c((paste(paste('A',1:5, sep=''), c("Frequency", "Severity", "Avoidance", "Work", "Relationships"), sep=' ')),
